...
1. Что бы работать с командой git clone нужно перейти
 по существующей ссылке где находится репозиторий.

2.  Скопировать ее код (ссылка находится под кнопкой code - кнопка зелоного цвета)

3. На рабочем столе или где удобно создаем папку 

4. VS открываем эту папку 

5. В терминале вводим команду git clone <ссылка ропозиторий>

6. Вводим команду cd и название папки которая притягивается ссылкой 

7. теперь можно работать в этой папке. 

8. Готовый файл с помощью команды git push можно обратно загружать в Git Hub

##  Pull reguest 


![картинка git](5048.png)
